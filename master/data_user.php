    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="data_user.php">Data</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><i>USER PENGGUNA</i></h5>
              ...
              <!-- Table with stripped rows -->
                ...
                <thead>
                  ...
                  <tr>
                    <th></th>
                    <th><select id="filter-nama_lengkap" style="width: 100%"></th>
                    <th><select id="filter-username"style="width: 100%"></th>
                    <th><select id="filter-password"style="width: 100%"></th>
                    <th><select id="filter-level"style="width: 100%"></th>
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                          <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">USER PENGGUNA</h5>
...
<script>
  ...
  <script>
                    $(document).ready(function() {
                        var columnNames = [
                            "aksi", "nama_lengkap", "username", "password", "level", "satuan_kerja"
                        ];
