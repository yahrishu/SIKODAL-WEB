    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="data_uo_pengguna.php">Data</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><i>INDUSTRI PERTAHANAN</i></h5>
              ...
              <!-- Table with stripped rows -->
                ...
                <thead>
                  <tr>
                    ...
                    <th style="width: 120px;">Tanggal SP</th>
                    <th style="width: 120px;">NOMOR SP</th>
                    <th style="width: 150px;">Tanggal Nomor SIPROD</th>
                    <th style="width: 120px;">NOMOR SIPROD</th>
                    <th style="width: 120px;">MASA BERLAKU</th>
                    <th style="width: 150px;">KET</th>
                </tr>
                <tr>
                    <th></th>
                    <th><select id="filter-NAMA_PERUSAHAAN" style="width: 100%"></select></th>
                    <th><select id="filter-ALAMAT" style="width: 100%"></select></th>
                    <th><select id="filter-KOTA" style="width: 100%"></select></th>
                    <th><select id="filter-PROVINSI" style="width: 100%"></select></th>
                    <th><select id="filter-Tanggal_SP" style="width: 100%"></select></th>
                    <th><select id="filter-NOMOR_SP" style="width: 100%"></select></th>
                    <th><select id="filter-Tanggal_Nomor_SIPROD" style="width: 100%"></select></th>
                    <th><select id="filter-NOMOR_SIPROD" style="width: 100%"></select></th>
                    <th><select id="filter-MASA_BERLAKU" style="width: 100%"></select></th>
                    <th><select id="filter-KET" style="width: 100%"></select></th>
                </tr>
                                </thead>
                <tbody>
                </table>
                ...
                <td class="last">
                  <a href="export_excel_indhan.php" class="btn btn-success" target="_blank">
                      <i class="bi bi-file-excel"></i> Excel
                  </a>
                </td>
                <td class="last">
                  <a href="export_pdf_indhan.php" class="btn btn-danger" target="_blank">
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                          <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">INDUSTRI PERTAHANAN</h5>
                              <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                              </button> -->
                          </div>
                          <div class="modal-body" id="detail_indhan">
              ...
              <script>
                $(document).ready(function () {
                    $(document).on('click', '.view_data', function () {
                        ...
                        $.ajax({
                            url: "fetch_indhan.php",
                            method: "POST",
                            data: { id: user_id },
                            success: function (data) {
                                $('#detail_indhan').html(data);
...
<script>
  ...
  <script>
                    $(document).ready(function() {
                        var columnNames = [
                            "view", "NAMA_PERUSAHAAN", "ALAMAT", "KOTA", "PROVINSI", 
