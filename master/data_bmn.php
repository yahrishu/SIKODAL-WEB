    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="data_bmn.php">Data</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><i>DATA BMN</i></h5>
              ...
              <!-- Table with stripped rows -->
                <table id="example1" class="table table-bordered table-striped nowrap" style="width: 100% !important;">                
                    ...
                    <tr>
                        <th></th>
                        <th><select id="filter-GOL" style="width: 100%"></select></th>
                        <th><select id="filter-BID" style="width: 100%"></select></th>
                        <th><select id="filter-KEL" style="width: 100%"></select></th>
                        <th><select id="filter-SUB_KEL" style="width: 100%"></select></th>
                        <th><select id="filter-SUB_SUB_KEL" style="width: 100%"></select></th>
                ...
                <td class="last">
                  <a href="export_excel_bmn.php" class="btn btn-success" target="_blank">
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                          <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">BARANG MILIK NEGARA</h5>
                              <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                              </button> -->
                          </div>
                          <div class="modal-body" id="detail_bmn">
