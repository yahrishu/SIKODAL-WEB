...
while ($row = $result->fetch_assoc()) {
    ...
    $sub_array['upload'] = '<button type="button" name="view" id="'.$row['id'].'" class="btn btn-warning btn-sm upload-gambar-nsn" data-id="'.$row['id'].'"><i class="bi bi-upload"></i></button>';
