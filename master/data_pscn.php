    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="data_pscn.php">Data</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                      ...
                      <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <div class="modal-body" id="detail_import">
                                <form action="import_pscn.php" method="POST" enctype="multipart/form-data">
                                      <div class="form-group row">
                                          <label class="col-sm-4 col-form-label">FILE IMPORT</label>
                                            <div class="col-sm-8">
                                              <input type="file" name="uploadfilepscn" id="uploadfilepscn" multiple class="form-control" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" >
                                              <a href="download.php?file=pscn.xlsx">Download Format Import Excel</a>
                                            </div>
                                      </div>
                                      <div class="modal-footer">
