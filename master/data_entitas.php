    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="data_entitas.php">Data</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div id="dataModal2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">UPLOAD FILE SERTIFIKAT</h5>
                            <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button> -->
                        </div>
                        <div class="modal-body" id="detail_upload_doc">
                            <!-- Data akan dimuat di sini -->
                        </div>
                        <div class="modal-footer">
                            <!-- <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button> -->
            ...
            $(document).ready(function () {
                $(document).on('click', '.upload_doc', function () {
                    var user_id = $(this).data('id');
                    $.ajax({
                        url: "fetch_upload_doc.php",
                        method: "POST",
                        data: { id: user_id },
                        success: function (data) {
                            $('#detail_upload_doc').html(data);
