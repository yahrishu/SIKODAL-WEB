    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="data_ncage.php">Data</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><i>NATO COMMERCIAL AND GOVERENMENT ENTITY</i></h5>
              ...
              <div id="dataModal1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id="detail_upload_file">
                            <!-- Data akan dimuat di sini -->
                        </div>
                        <div class="modal-footer">
                            <!-- <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button> -->
            ...
            <div id="dataModal2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Import Data NCAGE</h5>
                            
                        </div>
                          <div class="modal-body" id="detail_import">
                              <form action="import_ncage.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">FILE IMPORT</label>
                                          <div class="col-sm-8">
                                            <input type="file" name="uploadfilencage" id="uploadfilencage" multiple class="form-control" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" >
                                            <a href="download.php?file=ncage.xlsx">Download Format Import Excel</a>
                                          </div>
                                    </div>
                                    <div class="modal-footer">
            ...
            $(document).ready(function () {
                $(document).on('click', '.upload-file', function () {
                    var user_id = $(this).data('id');
                    $.ajax({
                        url: "fetch_upload_file.php",
                        method: "POST",
                        data: { id: user_id },
                        success: function (data) {
                            $('#detail_upload_file').html(data);
...
<script>
  ...
  <script>
                    $(document).ready(function() {
                        var columnNames = [
                            "cetak", "view", "upload", "NCAGE", "NCAGESD", "TOEC", "Entity_Name", "Street", "City",
