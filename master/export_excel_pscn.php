...
// Header kolom
$headers = [
    'MANUFACTURER_NAME', 'NCAGE', 'REFERENCE', 'FSC', 'NIIN', 'PSCN',
...
// Set judul sheet
$sheet->setTitle('Datap PSCN');

// Output
if (ob_get_length()) ob_end_clean();
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename="data_pscn.xlsx"');
