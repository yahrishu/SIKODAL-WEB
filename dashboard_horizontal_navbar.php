...
<!-- Navbar -->
<nav class="navbar navbar-expand-lg bg-white shadow-sm px-4 py-2 d-flex align-items-center justify-content-between">
  <div class="navbar-brand fw-bold fs-4">
    <img src="assets/img/logo.png" alt="Logo" width="30" class="me-2">
    SIKODAL
  </div>
  <ul class="nav">
    <li class="nav-item"><a class="nav-link" href="#">Dashboard</a></li>
    <li class="nav-item"><a class="nav-link" href="#">Pelayanan</a></li>
    <li class="nav-item"><a class="nav-link" href="#">Penetapan Nama Baku</a></li>
    <li class="nav-item"><a class="nav-link" href="#">Skrinning</a></li>
    <li class="nav-item"><a class="nav-link" href="#">Publikasi Katalog</a></li>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Puskod Baharwat Kemhan</span></strong>. All Rights Reserved
    </div>
