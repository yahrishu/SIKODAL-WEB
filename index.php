  ...
  <main>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <style>
                .text-merah {
                color: #ffd900ff !important; /* merah Bootstrap */
                }
                </style>
                <a href="#" class="logo d-flex align-items-center w-auto">
                    <span class="d-none d-lg-block text-merah"><center>SISTEM INFORMASI KODIFIKASI ALAT PERTAHANAN DAN KEAMANAN</center></span>
                </a>
              </div><!-- End Logo -->
    ...
    <style>
        ...
        body {
            ...
            background: url('assets/img/kemhan-1.jpg') no-repeat center center fixed;
        ...
        body::before {
            ...
            width: 100%;
            height: 100%;
            background: rgba(0, 0, 0, 0.4); /* efek gelap supaya form lebih jelas */
            z-index: -1;
        }
        main {
            flex: 1;
