<?php
    include "koneksi.php";
    $id  = $_GET['id'];
    $query = mysqli_query($koneksi, "SELECT * FROM pscn WHERE id = $id");
    $result = mysqli_fetch_array($query);
?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="assets/img/koppuskod.png" weight="150" height="150"><br><br>
<p style='margin-top:4.7pt;margin-right:-51.95pt;margin-bottom:.0001pt;margin-left:-1.0cm;font-size:27px;font-family:"Arial",sans-serif;font-weight:bold;text-decoration:underline;'>&nbsp;&nbsp;&nbsp;&nbsp;PSCN&nbsp;DETAILS<u><span style="text-decoration:none;"></span></u> </p>
<p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-right:-0.1pt;text-align:right;text-indent:-1.0cm;line-height:15.95pt;'><strong><span style="font-size:19px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $result['PSCN'];?></span></strong></p>
