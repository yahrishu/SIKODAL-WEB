    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><i>DATA KATALOG MATERIIL</i></h5>
              ...
              <!-- Table with stripped rows -->
                ...
                <thead>
                  <tr>
                    ...
                    <th style="width: 100px;">NAMA_MATERIIL</th>
                    <th style="width: 100px;">NSN</th>
                    <th style="width: 100px;">APPROVED_ITEM_NAME</th>
                    <th style="width: 100px;">INC</th>
                    <th style="width: 100px;">TIIC</th>
                    <th style="width: 100px;">NCAGE_MANUFACTURE</th>
                    <th style="width: 100px;">NEGARA</th>
                  </tr>
                  <tr>
                    <th></th>
                    ...
                    <th><select id="filter-NAMA_MATERIIL" style="width: 100%"></select></th>
                    <th><select id="filter-NSN" style="width: 100%"></select></th>
                    <th><select id="filter-APPROVED_ITEM_NAME" style="width: 100%"></select></th>
                    <th><select id="filter-INC" style="width: 100%"></select></th>
                    <th><select id="filter-TIIC" style="width: 100%"></select></th>
                    <th><select id="filter-NCAGE_MANUFACTURE" style="width: 100%"></select></th>
                    <th><select id="filter-NEGARA" style="width: 100%"></select></th>
                </tr>
                </thead>
                <tbody>
                </table>
                ...
                <td class="last">
                  <a href="export_excel_harwat.php" class="btn btn-success" target="_blank">
                      <i class="bi bi-file-excel"></i> Excel
                  </a>
                </td>
                <td class="last">
                  <a href="export_pdf_harwat.php" class="btn btn-danger" target="_blank">
                  ...
                  <div class="modal-dialog modal-xl" role="document">
                      <div class="modal-content">
                          <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">KATALOG HARWAT</h5>
                              <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                              </button> -->
                          </div>
                          <div class="modal-body" id="detail_katalog_harwat">
                ...
                $(document).ready(function () {
                    $(document).on('click', '.view_data', function () {
                        ...
                        $.ajax({
                            url: "fetch_katalog_harwat.php",
                            method: "POST",
                            data: { id: user_id },
                            success: function (data) {
                                $('#detail_katalog_harwat').html(data);
                    ...
                    $(document).ready(function() {
                        ...
                        var table = $('#example1').DataTable({
                            ...
                            columns: [
                                ...
                                { data: "NAMA_MATERIIL" },
                                { data: "NSN" },
                                { data: "APPROVED_ITEM_NAME" },
                                { data: "INC" },
                                { data: "TIIC" },
                                { data: "NCAGE_MANUFACTURE" },
                                { data: "NEGARA" }
