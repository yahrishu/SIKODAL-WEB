    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="data_ncb.php">Data</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><i>NATIONAL CODIFICATION BUREAU</i></h5>
              ...
              <!-- Table with stripped rows -->
                ...
                <thead>
                  <tr>
                    ...
                    <th style="width: 100px;">MOE CODE</th>
                    <th style="width: 100px;">COUNTRY NAME</th>
                    <th style="width: 100px;">NCAGE CODE</th>
                    <th style="width: 100px;">TIER STATUS</th>
                    <th style="width: 100px;">NATION TYPEN</th>
                  </tr>
                  <tr>
                    <th></th>
                    <th><select id="filter-FLAG"style="width: 100%"></th>
                    <th><select id="filter-COUNTRY_CODE" style="width: 100%"></th>
                    <th><select id="filter-MOE_CODE"style="width: 100%"></th>
                    <th><select id="filter-COUNTRY_NAME"style="width: 100%"></th>
                    <th><select id="filter-NCAGE_CODE"style="width: 100%"></th>
                    <th><select id="filter-TIER_STATUS"style="width: 100%"></th>
                    <th><select id="filter-NATION_TYPE"style="width: 100%"></th>
                </tr>
                </thead>
                <tbody>
                </table>
                ...
                <td class="last">
                  <a href="export_excel_ncb.php" class="btn btn-success" target="_blank">
                      <i class="bi bi-file-excel"></i> Excel
                  </a>
                </td>
                <td class="last">
                  <a href="export_pdf_ncb.php" class="btn btn-danger" target="_blank">
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                          <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">NAMA NCB</h5>
                              <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                              </button> -->
                          </div>
                          <div class="modal-body" id="detail_ncb">
                              <!-- Data akan dimuat di sini -->
                          </div>
                          <!-- <div class="modal-footer">
                              <button type="button" id="next-modal" class="btn btn-secondary" data-dismiss="modal" class="close">Cari FIIG</button>
                          </div> -->
                      </div>
                  </div>
                </div>
...
<script>
  ...
  <script>
                   $(document).ready(function() {
                        var columnNames = [
                            "VIEW", "FLAG", "COUNTRY_CODE", "MOE_CODE", "COUNTRY_NAME", "NCAGE_CODE", "TIER_STATUS", 
                            "NATION_TYPE"
                        ];
                        ...
                        var table = $('#example1').DataTable({
                            ...
                            initComplete: function(settings, json) {
                                ...
                                columnNames.forEach(function(colName, i) {
                                    if (colName === "view") return; // skip cetak

                                    var columnIndex = i;

                                    $.ajax({
                                        url: 'ncb_column_options.php',
                                        data: { column: colName },
                                        dataType: 'json',
                                        success: function(data) {
