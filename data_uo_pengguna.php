    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><i>UNIT ORGANISASI PENGGUNA</i></h5>
              ...
              <!-- Table with stripped rows -->
                ...
                <thead>
                  <tr>
                    <th>VIEW</th>
                    <th style="width: 100px;">KODE UO</th>
                    <th style="width: 100px;">UO</th>
                    <th style="width: 100px;">KODE SATKER</th>
                    <th style="width: 100px;">SATUAN KERJA</th>
                    <th style="width: 100px;">KUASA PENGGUNA ANGGARAN</th>
                    <th style="width: 100px;">KODE JENIS KEWENANGAN</th>
                    <th style="width: 100px;">JENIS KEWENANGAN</th> 
                  </tr>
                  <tr>
                    <th></th>
                    <th><select id="filter-KODE_UO" style="width: 100%"></th>
                    <th><select id="filter-UO"style="width: 100%"></th>
                    <th><select id="filter-KODE_SATKER"style="width: 100%"></th>
                    <th><select id="filter-SATUAN_KERJA"style="width: 100%"></th>
                    <th><select id="filter-KUASA_PENGGUNA_ANGGARAN"style="width: 100%"></th>
                    <th><select id="filter-KODE_JENIS_KEWENANGAN"style="width: 100%"></th>
                    <th><select id="filter-JENIS_KEWENANGAN"style="width: 100%"></th>
                </tr>
                </thead>
                <tbody>
                </table>
                ...
                <td class="last">
                  <a href="export_excel_uo.php" class="btn btn-success" target="_blank">
                      <i class="bi bi-file-excel"></i> Excel
                  </a>
                </td>
                <td class="last">
                  <a href="export_pdf_uo.php" class="btn btn-danger" target="_blank">
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                          <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">UNIT ORGANISASI PENGGUNA</h5>
                              <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                              </button> -->
                          </div>
                          <div class="modal-body" id="detail_uo">
...
<script>
  ...
  <script>
                    $(document).ready(function() {
                        var columnNames = [
                            "view", "KODE_UO", "UO", "KODE_SATKER", "SATUAN_KERJA", "KUASA_PENGGUNA_ANGGARAN", 
                        ...
                        var table = $('#example1').DataTable({
                            ...
                            columns: [
                                ...
                                { data: "KODE_SATKER" },
                                { data: "SATUAN_KERJA" },
                                { data: "KUASA_PENGGUNA_ANGGARAN" },
                                { data: "KODE_JENIS_KEWENANGAN" },
