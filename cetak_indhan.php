<?php
    include "koneksi.php";
    $id  = $_GET['id'];
    $query = mysqli_query($koneksi, "SELECT * FROM indhan WHERE id = $id");
    $result = mysqli_fetch_array($query);
?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="dist/img/koppuskod.png" weight="150" height="150"><br><br>
<p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-top:0cm;margin-right:-23.6pt;margin-bottom:.0001pt;margin-left:-1.0cm;line-height:15.95pt;'><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i> Data Industri Pertahanan </i></strong></p>
    ...
    <tbody>
        <tr>
            <td style="width: 854.9pt;padding: 0cm 5.4pt;vertical-align: top;">
                <p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-right:-23.6pt;line-height:15.95pt;'><strong><span style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i>NAMA PERUSHAAN</i></span></strong><strong><em><span style="font-size:14px;"> Code</span></em></strong></p>
                <p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-right:-23.6pt;line-height:15.95pt;'><span style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $result['NAMA_PERUSAHAAN'];?></span></p>
                ...
                <p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-right:-23.6pt;line-height:15.95pt;'><strong><span style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i>ALAMAT</i></span></strong><strong><em><span style="font-size:14px;">Status</span></em></strong></p>
                <p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-right:-23.6pt;line-height:15.95pt;'><span style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $result['ALAMAT'];?></span></p>
                <p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-right:-23.6pt;line-height:15.95pt;'><span style="font-size:14px;">&nbsp;</span></p>
                <p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-right:-23.6pt;line-height:15.95pt;'><strong><em><span style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i>PROVINSI</i></span></em></strong></p>
                <p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-right:-23.6pt;line-height:15.95pt;'><strong><em><span style="font-size:14px;"></span></em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $result['PROVINSI'];?></strong></p>
                ...
                <p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-right:-23.6pt;line-height:15.95pt;'><strong><em><span style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i>KOTA</i></span></em></strong></p>
                <p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-right:-23.6pt;line-height:15.95pt;'><span style="font-size:14px;">&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $result['KOTA'];?></p><br>
                <p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-right:-23.6pt;line-height:15.95pt;'><strong><em><span style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i> NCAGE</i></span></em></strong></p>
                <p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-right:-23.6pt;line-height:15.95pt;'><strong><em><span style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $result['NCAGE'];?></span></em></strong></p><br>
            </td>
            <!-- <td style="width: 654pt;padding: 0cm 5.4pt;vertical-align: top;">
                ...
                <p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-right:-23.6pt;line-height:15.95pt;'><strong><em><span style="font-size:14px;"><i>PSCN</i></span></em></strong><strong><span style="font-size:14px;"></span></strong></p>
                <p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-right:-23.6pt;line-height:15.95pt;'><span style="font-size:14px;"></span><?php echo $result['PSCN'];?>
...
<p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-top:0cm;margin-right:-23.6pt;margin-bottom:.0001pt;margin-left:-1.0cm;line-height:15.95pt;'><strong><u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;__________________________________________________________________________________________</u></strong></p>
<p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;'><strong><em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</em></strong></p>
<p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;text-indent:-1.0cm;'><strong><em>&nbsp;</em></strong></p><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
<p style='margin:0cm;font-size:15px;font-family:"Arial",sans-serif;margin-top:.85pt;margin-right:-66.1pt;margin-bottom:.0001pt;margin-left:1.2pt;text-indent:-29.55pt;'><strong><span style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PUSKOD Baharwat KEMHAN 
